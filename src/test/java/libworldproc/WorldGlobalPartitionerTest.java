...
public class WorldGlobalPartitionerTest {
	...
	public final void testRun() {
		...
		WorldGlobalPartitioner partitioner = new WorldGlobalPartitioner( client, world );
		partitioner.run();
...
//		Assert.assertEquals( 10, world.getAllRegionsAsList().size() );
	...
	public final void testSplit() {
		...
		Sector newSector = WorldGlobalPartitioner.split( s1, plane );
	...
	public void testGetAllHyperplanesFromSpaceRegion() {
		...
		sr.size.set( 4, 5, 6 );
		Set< Plane > planes = WorldGlobalPartitioner.getAllHyperplanesForSector( sr );
	...
	public final void testSplitTestIntersect() {
		...
		Set<Plane> planes = WorldGlobalPartitioner.getAllHyperplanesForSector(sr2);
		
		Assert.assertTrue( sr1.intersects( sr2 ) );
		Assert.assertTrue( sr2.intersects( sr1 ) );
		
		WorldGlobalPartitioner.splitSectorsWithPlanesFrom((GroupSector) sr1, planes);
...
//	17, 15  |_____|____| 29, 15
	...
	public void testGenerateLeafsForGroupsInWorld() {
		...
		WorldGlobalPartitioner.generateLeafsForWorld( world );
	...
	public void testHyperplanesFromGroupsInWorld() {
		...
		Set< Plane > planes = WorldGlobalPartitioner.generateHyperplanesForGroupSectorsInWorld(world);
	...
	public void testToString() {
		WorldGlobalPartitioner snapper = new WorldGlobalPartitioner( null, null );
