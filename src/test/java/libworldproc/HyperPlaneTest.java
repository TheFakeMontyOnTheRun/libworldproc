...
public class HyperPlaneTest {
	...
	/**
	 * Test method for {@link br.odb.worldprocessing.Plane#hashCode()}.
	 */
	@Test
	public void testHashCodeAndEqualsHyperplane() {
		...
		Plane plane0 = new Plane( Direction.N, gs );
		Plane plane1 = new Plane( Direction.N, gs );
		...
		plane0 = new Plane( Direction.N, 5 );

		Assert.assertFalse( plane0.hashCode() == plane1.hashCode() );
		Assert.assertFalse( plane0.equals( plane1 ) );

		plane0 = new Plane( Direction.N, gs2 );
		
		Assert.assertFalse( plane0.equals( plane1 ) );

		plane0 = new Plane( Direction.N, 5 );
		plane1 = new Plane( Direction.N, 5 );

		Assert.assertEquals( plane0.hashCode(), plane1.hashCode() );
		Assert.assertEquals( plane0, plane1 );
		Assert.assertEquals( plane1, plane0 );

		plane1 = new Plane( Direction.N, gs2 );
		plane0 = new Plane( Direction.N, gs2 );
		
		Assert.assertEquals( plane0, plane1 );
		Assert.assertEquals( plane1, plane0 );
		
		plane0 = new Plane( Direction.FLOOR, gs2 ); 
		
		Assert.assertFalse( plane0.equals( plane1 ) );
		
		gs2.localPosition.set( 0.0f, 0.0f, 7.0f );
		
		plane0 = new Plane( Direction.N, gs ); 
	...
	/**
	 * Test method for {@link br.odb.worldprocessing.Plane#toString()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link br.odb.worldprocessing.Plane#Hyperplane(br.odb.utils.Direction, float, br.odb.libscene.SpaceRegion)}.
	 */
	@Test
	public void testHyperplane() {
		...
		plane0 = new Plane( Direction.N, sr1 );
		Assert.assertEquals( 3.0f, plane0.v.z, 0.001f );
		
		plane0 = new Plane( Direction.E, sr1 );
		Assert.assertEquals( 5.0f, plane0.v.x, 0.001f );
		
		plane0 = new Plane( Direction.S, sr1 );
		Assert.assertEquals( 9.0f, plane0.v.z, 0.001f );
		
		plane0 = new Plane( Direction.W, sr1 );
		Assert.assertEquals( 1.0f, plane0.v.x, 0.001f );
		
		plane0 = new Plane( Direction.FLOOR, sr1 );
		Assert.assertEquals( 2.0f, plane0.v.y, 0.001f );
		
		plane0 = new Plane( Direction.CEILING, sr1 );
		Assert.assertEquals( 7.0f, plane0.v.y, 0.001f );
		
		
		plane0 = new Plane( Direction.N, 4 );
		Assert.assertEquals( 4.0f, plane0.v.z, 0.001f );
		
		plane0 = new Plane( Direction.E, 5 );
		Assert.assertEquals( 5.0f, plane0.v.x, 0.001f );
		
		plane0 = new Plane( Direction.S, 6 );
		Assert.assertEquals( 6.0f, plane0.v.z, 0.001f );
		
		plane0 = new Plane( Direction.W, 7 );
		Assert.assertEquals( 7.0f, plane0.v.x, 0.001f );
		
		plane0 = new Plane( Direction.FLOOR, 8 );
		Assert.assertEquals( 8.0f, plane0.v.y, 0.001f );
		
		plane0 = new Plane( Direction.CEILING, 9 );
		Assert.assertEquals( 9.0f, plane0.v.y, 0.001f );
		
	}

	/**
	 * Test method for {@link br.odb.worldprocessing.Plane#stabXY(br.odb.libscene.Sector)}.
	 */
	@Test
	public void testStabXY() {
		...
		Plane plane0 = new Plane( Direction.S, sr1 );
	...
	/**
	 * Test method for {@link br.odb.worldprocessing.Plane#stabXZ(br.odb.libscene.Sector)}.
	 */
	@Test
	public void testStabXZ() {
		...
		Plane plane0 = new Plane( Direction.FLOOR, sr1 );
	...
	/**
	 * Test method for {@link br.odb.worldprocessing.Plane#stabYZ(br.odb.libscene.Sector)}.
	 */
	@Test
	public void testStabYZ() {
		...
		Plane plane0 = new Plane( Direction.W, sr1 );
